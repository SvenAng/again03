...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="zf-2col-stacked <?php print $classes;?>">
  ...
  <?php if (!empty($left) || !empty($right)): ?>
    <div class="<?php print $zf_wrapper_classes; ?>">
      <<?php print $left_wrapper ?> class="group-left small-12 medium-6 large-7 columns<?php print $left_classes; ?>">
      <?php print $left; ?>
      </<?php print $left_wrapper ?>>

      <<?php print $right_wrapper ?> class="group-right small-12 medium-6 large-5 columns<?php print $right_classes; ?>">
      <?php print $right; ?>
